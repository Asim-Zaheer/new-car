...
document.addEventListener("DOMContentLoaded", function() {
  ...
  $("#phoneNumber").on("click", function () {
    ...
    $("#phoneNumber a").replaceWith(
      `<a href="tel:${phone}"><i class='bx bx-phone-call'></i> ${phone}</a>`
    );
  });
  $("#emailAdress").on("click", function () {
    let email = $(this).data("email");
    $("#emailAdress a").replaceWith(
      `<a href="mailto:${email}"><i class='bx bx-at'></i>${email}</a>`
    );
  });
  $("#emailAdresss").on("click", function () {
    ...
    $("#emailAdresss a").replaceWith(
      `<a href="${emails}"><i class='bx bxl-whatsapp'></i>${whatsapp}</a>`
    );
  });
