    ...
    <>
      <div className="tt-magic-cursor">
        ...
        <div className="home5-banner-area">
          <div className="paginations111"></div>
          <div className="swiper home3-banner-slider">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(180deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url("assets/img/home5/home5-banner-img-01.png")',
                  }}
                ></div>
              </div>
            </div>
                ...
                <div className="banner-content">
                  ...
                  <div className="home6-search-area mb-100">
                    <div className="container">
                      <form>
                        <div className="row row-cols-xl-6 row-cols-md-3 row-cols-sm-2 row-cols-1 g-3 justify-content-center">
                          <div className="col">
                            <div className="form-inner">
                              <label>Pickup location</label>
                              <select>
                                <option>Larnaka Airport</option>
                                <option>Pafos Airport</option>
                                <option>Pafos Office</option>
                                <option>Limassol Office</option>
                                <option>Ayia Napa Office</option>
                                <option>Nicosia Office</option>
                                <option>Recondition Car</option>
                                <option data-locid="x2" value="GET">
                        ...
                        <div className="product-card">
                          <div className="product-img">
                            <div className="swiper product-img-slider">
                              <div className="swiper-wrapper">
                                <div className="swiper-slide">
                                  <img src="assets/img/inner-page/001.png" />
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="product-content">
                            <h5>
                              <a href="car-deatils.html">Nissan Altima-2022</a>
                            </h5>
                            <div className="price-location">
                              ...
                              <div className="location">
                                <a href="#">
                                  <i className="bi bi-geo-alt"></i> Panama City
                                </a>
                              </div>
                            </div>
                            <ul className="features">
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (2).svg"
                                  alt
                                />
                                Engine Size: 1000cc
                              </li>
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (4).svg"
                                  alt
                                />
                                Adults: 2
                              </li>
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (3).svg"
                                  alt
                                />
                                Doors: 5
                              </li>
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (5).svg"
                                  alt
                                />
                                Children: 2
                              </li>
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (6).svg"
                                  alt
                                />
                                Seats: 4
                              </li>
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (7).svg"
                                  alt
                                />
                                Big Luggage: -
                              </li>
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (8).svg"
                                  alt
                                />
                                Small Luggage: -
                              </li>
                              ...
                              <li>
                                <img
                                  src="assets/img/home4/icon/Resized_svg (9).svg"
                                  alt
                                />
                                AC
                              </li>
                ...
                <div className="product-sidebar">
                  <div className="product-widget mb-20">
                    <div className="check-box-item">
                      <h6 className="product-widget-title mb-20">
                        Vehicle Type
                      </h6>
                        ...
                        <ul>
                          ...
                          <li>
                            <label className="containerss">
                              <input type="checkbox" />
                              <span className="checkmark"></span>
                              <span className="text">Cabrio / Open Top</span>
                              <span className="qty">(1,234)</span>
                            </label>
                          </li>
                          <li>
                          ...
                          <li>
                            <label className="containerss">
                              <input type="checkbox" />
                              <span className="checkmark"></span>
                              <span className="text">SUV / 4WD</span>
